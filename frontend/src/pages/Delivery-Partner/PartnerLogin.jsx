...
function PartnerLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoadingBtn(true)
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/partner/login`, {
                method: "POST",
                headers: {
    ...
    return (
        <div className='flex flex-wrap justify-center items-center h-auto py-10'>
            <div className="w-96 mx-auto bg-white p-8 rounded-2xl shadow-none lg:shadow-md">
                <h1 className="text-3xl text-black font-bold mb-6 flex flex-wrap justify-center">Delivery Partner Login</h1>
                <h3 className="text-gray-700">Not registered? <Link className='font-bold text-[#FFB500]' to="/partner-register">Register</Link></h3>
