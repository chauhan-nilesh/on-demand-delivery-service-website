    ...
    return (
        ...
        <section className='bg-white flex-grow h-full lg:min-h-dvh lg:h-dvh lg:pb-8 pb-20'>
            <div className='lg:my-10 my-5 mx-3 lg:mx-5'>
                <h2 className='text-3xl text-zinc-900 font-extrabold tracking-tightr'>Profile</h2>
                <div className='w-full grid grid-flow-row-dense lg:grid-cols-2 gap-4 mt-7'>
                    <Link to="/partner/update-profile">
                        <div className='bg-gray-50 p-5'>
                            <div className='flex'>
                                ...
                                <div className='ml-4'>
                                    <h3 className='font-bold text-gray-800 text-xl'>Partner Profile</h3>
                    ...
                    <Link to="/partner/set-payment">
                        <div className='bg-gray-50 p-5'>
                            <div className='flex'>
                                <div className='flex justify-center items-center'>
                                    <img src="/payout.png" alt="addresses" className='h-10' />
                                </div>
                                <div className='ml-4'>
                                    <h3 className='font-bold text-gray-800 text-xl'>Manage Payment Details</h3>
                                    <p className='text-sm text-gray-500'>Add and manage payout payment details</p>
                                </div>
                            </div>
                        </div>
                    </Link>

                    <Link to="/partner/change-password">
                        <div className='bg-gray-50 p-5'>
                            <div className='flex'>
                                <div className='flex justify-center items-center'>
