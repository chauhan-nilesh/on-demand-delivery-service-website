                        ...
                        {orders.map((order, index) => {
                            if (index < 4) {
                                return <tr key={index}>
                                    ...
                                    <td>
                                        <Link to={"/company/orders/" + order?._id} className='p-2 rounded-lg font-bold text-slate-800 bg-[#FFB500] tracking-wide'>Details</Link>
                                    </td>
                                </tr>
                            }
                        })}
...
export default CompanyQuicktable